  ...
  return (
    <div>
      ...
      <form onSubmit={onSubmit}>
        {/* 원자재 이름 */}
        <input type="text" placeholder='원자재 이름' value={name} onChange={changeNameHandler}/>
        {/* 원자재 가격 */}
        <input type="text" placeholder='원자재 가격' value={price} onChange={changePriceHandler}/>
        {/* 원자재 브랜드 */}
        <input type="text" placeholder='원자재 브랜드' value={brand} onChange={changeBrandHandler}/>
